<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('name', $data['name'], ['class' => 'form-control','placeholder'=>'Page name']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('alias', $data['alias'], ['class' => 'form-control','placeholder'=>'Page alias']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::textarea('text', $data['text'], ['id'=>'editor','class' => 'form-control','placeholder'=>'Page description']) !!}
        </div>
    </div>
